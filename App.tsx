...
import { MapPin, User, CreditCard, Shield, Share2, Phone, Mail, Upload, Check, X, Star, Clock, Car, Users, Moon, GraduationCap, Plus, ChevronRight, Menu, ArrowLeft, Search, Navigation, Zap, Settings, Heart, MessageCircle, Send, Smile, Camera, Mic, Bell, Lock, HelpCircle, FileText, Globe, Smartphone, Volume2, Eye, LogOut } from 'lucide-react';
      ...
      <div className="p-6 space-y-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-400">Receive ride updates and alerts</p>
              </div>
              <button 
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-400">Ride receipts and updates</p>
              </div>
              <button 
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-400">Critical ride updates only</p>
              </div>
              <button 
                onClick={() => updateSettings('notifications', 'sms', !settings.notifications.sms)}
                className={`w-12 h-6 rounded-full transition-colors ${
                  settings.notifications.sms ? 'bg-blue-600' : 'bg-gray-600'
                }`}
              >
                <div className={`w-5 h-5 bg-white rounded-full transition-transform ${
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-400">Student discounts and deals</p>
              </div>
              <button 
                onClick={() => updateSettings('notifications', 'promotions', !settings.notifications.promotions)}
                className={`w-12 h-6 rounded-full transition-colors ${
                  settings.notifications.promotions ? 'bg-blue-600' : 'bg-gray-600'
                }`}
              >
                <div className={`w-5 h-5 bg-white rounded-full transition-transform ${
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-400">Allow drivers to see your location</p>
              </div>
              <button 
                onClick={() => updateSettings('privacy', 'shareLocation', !settings.privacy.shareLocation)}
                className={`w-12 h-6 rounded-full transition-colors ${
                  settings.privacy.shareLocation ? 'bg-blue-600' : 'bg-gray-600'
                }`}
              >
                <div className={`w-5 h-5 bg-white rounded-full transition-transform ${
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="font-medium">Share Ride History</p>
                <p className="text-sm text-gray-400">Help improve route suggestions</p>
              </div>
              <button 
                onClick={() => updateSettings('privacy', 'shareRideHistory', !settings.privacy.shareRideHistory)}
                className={`w-12 h-6 rounded-full transition-colors ${
                  settings.privacy.shareRideHistory ? 'bg-blue-600' : 'bg-gray-600'
                }`}
              >
                <div className={`w-5 h-5 bg-white rounded-full transition-transform ${
                  settings.privacy.shareRideHistory ? 'translate-x-6' : 'translate-x-1'
                }`}></div>
              </button>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-400">Price display currency</p>
              </div>
              <select 
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-400">App sounds and notifications</p>
              </div>
              <button 
                onClick={() => updateSettings('preferences', 'soundEnabled', !settings.preferences.soundEnabled)}
                className={`w-12 h-6 rounded-full transition-colors ${
                  settings.preferences.soundEnabled ? 'bg-blue-600' : 'bg-gray-600'
                }`}
              >
                <div className={`w-5 h-5 bg-white rounded-full transition-transform ${
        ...
        <div className="bg-gray-800 bg-opacity-50 rounded-xl p-6">
          ...
          <div className="space-y-3">
            <button className="w-full bg-gray-700 hover:bg-gray-600 text-white py-3 rounded-lg transition-colors text-left px-4">
              <div className="flex items-center justify-between">
        ...
        <div className="bg-gray-800 bg-opacity-50 rounded-xl p-6">
          <div className="space-y-3">
            <button className="w-full bg-yellow-600 hover:bg-yellow-500 text-white py-3 rounded-lg transition-colors font-semibold">
              <div className="flex items-center justify-center space-x-2">
            ...
            <button 
              ...
              className="w-full bg-red-600 hover:bg-red-500 text-white py-3 rounded-lg transition-colors font-semibold"
            >
              <div className="flex items-center justify-center space-x-2">
        ...
        <div className="text-center text-gray-400 text-sm">
          <p>VAR LIFE v2.1.0</p>
          <p>© 2024 VAR LIFE. All rights reserved.</p>
        </div>
      </div>
    </div>
  );
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-xl text-center">
            ...
            <p className="text-gray-800 font-medium">
              {currentScreen === 'welcome' ? 'Signing out...' : 'Processing...'}
            </p>
          </div>
        </div>
      )}
